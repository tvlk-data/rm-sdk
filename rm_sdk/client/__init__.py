...
class RMConfig(object):
  """This is config object for RM-SDK which will injected to rm-sdk object
  ...
  def __init__(self, config_dict):
    ...
    self._config['MODEL_UPLOAD_URI'] = config_dict.get('MODEL_UPLOAD_URI', 'gs://rm-project-artifacts')
...
class RMClient(object):
  ...
  def create_model_run(self, runId, base_path, delete_old_data=True):
    """Factory method for creating ModelRun object
      ...
      :type runId: str
      :param base_path: Base path of the project where base_path/models will hold the
      generated models
      :type base_path: str
      :param delete_old_data: whether RM-SDK is allowed to clean up old metrics of the same runId
      :type delete_old_data: boolean
